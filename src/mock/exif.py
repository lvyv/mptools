...
async def stream_info():
    ...
    item = {'version': '1.0.0',
            'channels': [
                ...
                {'deviceid': '44020000001320000001', 'channelid': '44020000001310000001', 'desc': '605大厅',
                 'url': 'rtsp://192.168.1.7/live'},
                {'deviceid': '54020000001320000001', 'channelid': '54020000001310000001', 'desc': '608停车区',
                 'url': 'rtsp://user:userpass@192.168.1.6:7554/plc'}
            ]}
    return item
