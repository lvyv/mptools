...
def create_gallery_json(gallery_root, remote_link, use_defaults=False, tt="My Gallery", desc="Description"):
    """
    ...
    if not use_defaults:
        ...
        gallery_config["url"] = input(
            f'What is your site URL? This is only needed to better show'
            f' links to your galleries on social media (default: "")\n'
        )
...
def gallery_create(rootdir, imagedir=None):
    gallery_root = rootdir

    # Get the image source directory
    image_source = imagedir
